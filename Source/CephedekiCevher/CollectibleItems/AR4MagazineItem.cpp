#include "AR4MagazineItem.h"

#include "Components/StaticMeshComponent.h"

#include "UObject/ConstructorHelpers.h"

AAR4MagazineItem::AAR4MagazineItem(){
	MagazineMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("AR4_MAGAZINE"));
	MagazineMesh->SetupAttachment(GetRootComponent());

	CollectibleMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("AR4_CollectibleMesh"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> GetMagazineMesh(TEXT("/Game/_Weapons/Meshes/AR4/SM_AR4_Mag_Empty"));
...
void AAR4MagazineItem::BeginPlay(){
	Super::BeginPlay();	
	MagazineMesh->SetHiddenInGame(true);
}

void AAR4MagazineItem::Tick(float DeltaTime){
